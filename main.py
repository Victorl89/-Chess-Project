...
gdirectory = ''  # Καθορίζει τον τρέχοντα κατάλογο για φόρτωση των εικόνων πιο κάτω.
...
class ChessboardGUI:
    def __init__(self, master, moves=None):
        ...
        # Δημιουργία καμβά για τη σκακιέρα και πλαίσιο κειμένου για τις κινήσεις.
        self.board_canvas = tk.Canvas(self.master, width=800, height=800)
        ...
        self.moves_text.config(yscrollcommand=self.scrollbar.set)
        # Δημιουργία κουμπιών για τις κινήσεις.
        self.next_button = tk.Button(self.master, text="Next Move", command=self.go_next, bg='#654321', fg='white')
        self.next_button.pack(side=tk.RIGHT, padx=29, pady=10)
        self.previous_button = tk.Button(self.master, text="Previous Move", command=self.go_previous, bg='#654321',
                                         fg='white')
        self.previous_button.pack(side=tk.LEFT, padx=30, pady=10)
        # Εάν υπάρχουν κινήσεις, εισάγουμε τις κινήσεις στο πλαίσιο κειμένου.
        if self.moves:
